  ...
  const elements = [
    {
      ...
      updateAvailable:
        compareVersions(app?.helm_version, githubRelease?.helm?.replace(/^[a-zA-Z]/, '')) ===
        'githubRelease',
    },
    {
      position: 1,
      ...
      updateAvailable:
        compareVersions(app?.helm_core, githubRelease?.core?.replace(/^[a-zA-Z]/, '')) ===
        'githubRelease',
    },
    {
      position: 1,
      ...
      updateAvailable:
        compareVersions(app?.helm_api, githubRelease?.api?.replace(/^[a-zA-Z]/, '')) ===
        'githubRelease',
    },
    {
      position: 2,
      ...
      updateAvailable:
        compareVersions(app?.helm_ui, githubRelease?.ui?.replace(/^[a-zA-Z]/, '')) ===
        'githubRelease',
    },
    {
      position: 3,
      ...
      updateAvailable:
        compareVersions(app?.helm_watchdog, githubRelease?.watchdog?.replace(/^[a-zA-Z]/, '')) ===
        'githubRelease',
    },
  ];
